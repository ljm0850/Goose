...
<div class="container">
    ...
    <div class="container box">
        <ul v-for="article in state.halfArticleList">
            <ul class="d-flex justify-content-between">
                <li class="article" data-bs-toggle="modal" data-bs-target="#studyArticleDetail" @click="selectArticle" :key="article.id">{{article.title}}</li>
